...
export async function seed(knex: Knex): Promise<void> {
    ...
    await knex("clean").del();
    await knex("quote").del();
    await knex("pickup").del();
    ...
    await knex("users").insert([
        ...
        {
          id:'dKZ7MVCGhCc9kJ1JYeob6qXlYcF4',
          display_name:'chris',
          mobile:'51823009',
        ...
        {
          id:'dKZ7MVCGhCc9kJ1JYeob6qXlYcF5',
          display_name:'amy',
          mobile:'51823010',
          email: 'amy@gmail.com',
          password: '$2a$10$m7hvMDhAT0s.huoG4L1X/.QpqiguGHEF5uQ1gThs.HjWerAYNYhtu',        
    ...
    ordersData.push({
        order_items:'p3d2w3l4t12',
        pickup_date_time:'Thurday, May 25th 2023, 6:39:45 pm',
        area:'2',
        area_value:"九龍",
        district:'2-3',
        district_value:"九龍城區",
    ...
    ordersData.push({
        order_items:'p3d2w3l4t12',
        pickup_date_time:'Saturday, May 27th 2023, 6:39:45 pm',
        area:'2',
        area_value:"九龍",
        district:'2-3',
        district_value:"九龍城區",
    ...
    ordersData.push({
        order_items:'p4d2w3l4t13',
        pickup_date_time:'Sunday, May 28th 2023, 6:39:45 pm',
        area:'2',
        area_value:"九龍",
        district:'2-3',
        district_value:"九龍城區",
    ...
    ordersData.push({
        order_items:'p5d2w3l4t14',
        pickup_date_time:'Monday, May 29th 2023, 6:39:45 pm',
        area:'2',
        area_value:"九龍",
        district:'2-3',
        district_value:"九龍城區",
